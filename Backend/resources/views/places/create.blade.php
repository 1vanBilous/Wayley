        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     {!! Form::open(['action'=>'PlacesController@store', 'files'=>true]) !!}
                        ...
                        <div class="form-group row">
                            <div class="col-md-5 mb-3"> <label for="firstName">Cyrillic name</label>
                                <input type="text" class="form-control" id="nameCyr" placeholder="" value="" required="" name="nameCyr">
                            </div>
                            ...
                            <div class="col-md-5 mb-3"> <label for="lastName">Latin name</label>
                                <input type="text" class="form-control" id="nameLat" placeholder="" value="" required="" name="nameLat">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input required="required" name="picture" type="file" id="picture"   class="form-control">
                            </div>
                        </div>
